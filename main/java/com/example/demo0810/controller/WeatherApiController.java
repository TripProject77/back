...
import com.example.demo0810.dto.WeatherResponseDTO;
...
public class WeatherApiController {
    ...
    @GetMapping
    @Transactional
    public ResponseEntity<WeatherResponseDTO> getRegionWeather(@RequestParam ("regionId") Long regionId) {
        ...
        WeatherDto prevWeather = region.getWeather();
        ...
        try {
            ...
            WeatherDto weather = new WeatherDto(temp, rainAmount, humid, currentChangeTime);
